...
def main():
    ...
    tar_data = torch.load('/data/HaoChen/knowledge_distillation/Overfit/tar_pretrain_num4_v2.pkl')
    print("Loaded inputFeature_pretrain !")
    print("Loading dW_pretrain ...")
    dw_data = torch.load('/data/HaoChen/knowledge_distillation/Overfit/dx_pretrain_num4_v2.pkl')
    ...
    for filter_order in filter_show:
        ...
        # print("Saving PCA...")
        # dir = "./pca_data/init/filter(%d,%d)/" % (filter_order + 1, filter_num)
        # if not os.path.exists(dir):
        #     os.makedirs(dir)
