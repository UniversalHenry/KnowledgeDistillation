...
def main():
    ...
    tar_data = torch.load('/data/HaoChen/knowledge_distillation/PCA/tar_pretrain_0CUB200_full.pkl')
    ...
    for filter_order in filter_show:
        ...
        # print("Saving PCA...")
        # dir = "./pca_data/pretrain_ZX/filter(%d,%d)/" % (filter_order + 1, filter_num)
        # if not os.path.exists(dir):
        #     os.makedirs(dir)
