...
def main():
    ...
    tar_data = torch.load('/data/HaoChen/knowledge_distillation/PCA/tar_pretrain_0_init_vgg11.pkl')
    print("Loaded inputFeature_pretrain !")
    print("Loading dW_pretrain ...")
    dw_data = torch.load('/data/HaoChen/knowledge_distillation/PCA/dx_pretrain_0_init_vgg11.pkl')
